...
replace surveyid = "DO1986DHS" if surveyid == "DR1986DHS"
replace surveyid = "SD1989DHS" if surveyid == "SD1990DHS"
replace surveyid = "GT1987DHS" if surveyid == "GU1987DHS"
replace surveyid = "LR1986DHS" if surveyid == "LB1986DHS"
save, replace
*/
tempfile dhs hefpi
...
foreach var of var c_underweight c_underweight_sev c_stunted c_stunted_sev c_wasted c_wasted_sev c_stu_was c_stu_was_sev {
egen value_my`var' = wtmean(`var'),weight(ant_sampleweight)
}
