////////////////////////////////////////////////////////////////////////////////////////////////////
*** DHS MONITORING: I Majority survey
////////////////////////////////////////////////////////////////////////////////////////////////////
...
DW-RW NOV2021: Sudan successfully replicated.
*/
/*
...
use "${SOURCE}/DHS-`name'/DHS-`name'hh.dta", clear
	gen name = "`name'"
	do "${DO}/18_generate_hmdata.do"
save "${SOURCE}/DHS-`name'/DHS-`name'hm2.dta",replace
...
use "${SOURCE}/DHS-`name'/DHS-`name'birth.dta", clear	
	...
	cap gen c_motherln = v003 /*for DHS-I only*/
...
keep hhid hv001 hm_shstruct* hv002  hh_* 
save `hh',replace
...
replace country = "SriLanka" if country == "Sri Lanka"
...
if miss_b16 != 1 {
  ...
  use `hm',clear //when b16 is not missing, the hm.dta can be merged with birth.dta, the final microdata has all household member info
    ...
    merge 1:m hv001 hm_shstruct1 hm_shstruct2 hv002 hvidx using `birth',update              //missing update is zero, non missing conflict for all matched.(hvidx different) 
...
*** Specify sample size to HEFPI
	...
	***for variables generated from 8_child_illness	
	...
	c_diarrheaact_q	c_fever	c_fevertreat	c_illness	c_illtreat	c_illness2	c_illtreat2 c_sevdiarrhea	c_sevdiarrheatreat ///
